...
Made from the source code of [RUNGRAM](t.me/rungram)

Special thanks to [this person](t.me/bot_devloaper) for helping me.

Deploy a bot like me [now](t.me/rungram)

Check [🤖More bot](https://t.me/tobot_list).

Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/group_tobot?startgroup=true).
"""
